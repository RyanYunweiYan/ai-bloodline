...
**▶ 在线体验：https://ryanyunweiyan.github.io/ai-bloodline/**（建议桌面端访问，支持拖拽环绕、滚轮缩放、点击节点查看详细关系。）
...
我想做的是个干净的、能溯源的干净底座。图是个钩子，背后这套“怎么让 AI 别瞎编”的洗数据流程，才是我真正拿出来分享的。
...
接下来的打算：补核心人物 → 标注关系权重 → 出英文版 → 开放任意人物输入查询。
